...
def main():
    ...
    # Model
    model = model_loader.get_model(args.model, input_size=input_size, in_channels=in_channels, num_classes=num_classes, device=device, weight_path=args.load_weight)
    start_epoch = 1
